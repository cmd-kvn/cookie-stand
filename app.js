...
var SeaTacAirport = {
  ...
  // Display the values of each array as unordered lists in the browser
  seaTacAirportHours: function () {
    // Locate the node
    var contentArea = document.getElementById('seatac_airport_hours_list');
    ...
    p.textContent = 'SeaTac Airport'; // Set the p element
    // Loop through the openHours (inclusive) to set each li element with an element from the array from cookiesAtHour()
    // The <= allows an index for the total cookies
    for (var i = 0; i <= openHours.length; i++) {
      li = document.createElement('li');
...
// Test SeaTacAirport functions
SeaTacAirport.custPerHr();
SeaTacAirport.cookiesPerHr();
SeaTacAirport.cookiesAtHour();

// SeattleCenter===SeattleCenter===SeattleCenter===SeattleCenter===SeattleCenter===SeattleCenter===SeattleCenter===SeattleCenter===
var SeattleCenter = {
  // Store the min/max hourly customers, and the average cookies per customer, in object properties
  minCustPerHr: 11,
  maxCustPerHr: 38,
  ...
  // Display the values of each array as unordered lists in the browser
  seattleCenterHours: function () {
    // Locate the node
    var contentArea = document.getElementById('seattle_center_hours_list');
    ...
    p.textContent = 'Seattle Center'; // Set the p element
    // Loop through the openHours (inclusive) to set each li element with an element from the array from cookiesAtHour()
    // The <= allows an index for the total cookies
    for (var i = 0; i <= openHours.length; i++) {
      li = document.createElement('li');
...
// Test SeattleCenter functions
SeattleCenter.custPerHr();
SeattleCenter.cookiesPerHr();
SeattleCenter.cookiesAtHour();
